package com.amitupadhyay.faceauth.cropwork;
...
/**
 * Created by aupadhyay on 5/26/17.
 */
...
public class ResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.saveImageBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                savePersonImageInResult();
            }
        });
    ...
    private void savePersonImageInResult()
    {
